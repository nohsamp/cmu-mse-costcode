...
public class Logger {
	...
	public static void logDebug(Class<?> caller, String message, Throwable t) {
	...
	public static void logError(Class<?> caller, String message, Throwable t) {
