...
public class WebService {
	 ...
	 * @param methodName
	 *            The method name for Web Service
	 * @param url
	...
	/**
	 * Call the web service with methodName and return the SOAP object as a
	...
	/**
	 * Call the default web service method and return the SOAP object as a
	 * return value of Web Service
	 * 
	 * @param arguments
	 *            The arguments of method
	 * @return Web Service result (SOAP object)
	 */
	public SoapObject invokeMethod(Map<String, String> arguments)
			throws Exception {
	...
	/**
	 * @param envelope
	 *            The envelope of Web Service
	 * @return Web Service result (SOAP object)
	 * @throws Exception
	 */
	private SoapObject makeCall(SoapSerializationEnvelope envelope)
			throws Exception {
