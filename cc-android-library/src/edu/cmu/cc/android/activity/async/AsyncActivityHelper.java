...
/**
 * DESCRIPTION: This class provides progress dialog methods for Asynchronous
 * activities.
 * 
...
public class AsyncActivityHelper {
	...
	public void showProgressDialog(int textResID) {
		dialog = ProgressDialog.show(ctx, null, ctx.getString(textResID), true);
	}
	...
	public void showProgressDialog(int titleResID, int textResID) {
		dialog = ProgressDialog.show(ctx, ctx.getString(titleResID),
