...
/**
 * DESCRIPTION: All activities that are going to use asynchronous tasks should
 * implement this interface. It specifies progress dialog window methods.
 * 
...
public interface IAsyncActivity {
	...
	/**
	 * This method will be called by the Async Task classes to notify the async
	 * activity about the error happened during the task execution.
	 * 
	 * @param taskClass
	 *            - calling task class
	 * @param t
