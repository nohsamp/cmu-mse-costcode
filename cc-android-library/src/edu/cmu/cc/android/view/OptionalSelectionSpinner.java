...
/**
 * DESCRIPTION: Custom spinner class. It assigns a custom adapter to the
 * spinner.
 * 
...
public class OptionalSelectionSpinner<T> extends Spinner {
	...
	public OptionalSelectionSpinner(Context ctx, AttributeSet attrs, T emptyItem) {
		super(ctx, attrs);
	...
	public void setAdapter(SpinnerAdapter adapter) {
		...
		if (adapter instanceof OptionalSelectionSpinnerAdapter) {
			...
			super.setAdapter(new OptionalSelectionSpinnerAdapter<T>(ctx,
					adapter, emptyItem));
		}
	}
