...
public class SLViewAdapter extends AbstractViewAdapter {
	...
	public static void updateView(View view) {
		...
		WidgetUtils.getEditText(view, R.id.et_sl_name).setText(sl.getName());
		WidgetUtils.getEditText(view, R.id.et_sl_comment).setText(
				sl.getDescription());

		WidgetUtils.getTextView(view, R.id.tv_sl_date).setText(
	...
	public static void updateModel(View view) {
		...
		sl.setName(WidgetUtils.getEditTextAsString(view, R.id.et_sl_name));

		sl.setDescription(WidgetUtils.getEditTextAsString(view,
				R.id.et_sl_comment));
