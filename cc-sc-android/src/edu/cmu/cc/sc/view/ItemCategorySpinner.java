...
public class ItemCategorySpinner extends ValidatingSpinner<ItemCategory> {
	...
	private static ItemCategory getEmptyItem() {
		...
		String emptyItemCaption = ctx.getResources().getString(
				R.string.sl_item_category_empty);
	...
	private void initializeAdapter() {
		...
		Map<Long, ItemCategory> categoriesMap = ApplicationState.getInstance()
				.getCategories();
