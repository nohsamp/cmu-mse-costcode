...
public class SaveSLItemTask extends AsyncTask<Item, Void, Void> {
	...
	private SoapObject saveServerSLItem(Item item) throws Throwable {
		...
		arguments.put(ctx.getString(R.string.ws_sl_item_property_sl),
				String.valueOf(item.getShoppingList().getId()));
		arguments.put(ctx.getString(R.string.ws_sl_item_property_category),
				item.getCategory());
		arguments.put(ctx.getString(R.string.ws_sl_item_property_name),
				item.getName());
		arguments.put(ctx.getString(R.string.ws_sl_item_property_quantity),
				String.valueOf(item.getQuantity()));
		arguments.put(ctx.getString(R.string.ws_sl_item_property_price),
				String.valueOf(item.getPrice()));
		arguments.put(ctx.getString(R.string.ws_sl_item_property_unit),
				String.valueOf(item.getUnit()));
		arguments.put(ctx.getString(R.string.ws_sl_item_property_desc),
				item.getDescription());

		return service
				.invokeMethod(
						ctx.getString(R.string.ws_sl_item_method_saveSLItem),
						arguments);
	}
